  ...
  return (
    <Card className="overflow-hidden border-primary/30">
      <div className="grid gap-4 sm:gap-6 lg:grid-cols-[300px_1fr]">
        <div className="relative flex h-[240px] sm:h-[280px] items-center justify-center">
          <motion.div
            className="absolute h-36 w-36 sm:h-44 sm:w-44 rounded-full bg-primary/20 blur-2xl"
            animate={{ opacity: [0.45, 0.9, 0.45], scale: [0.92, 1.05, 0.92] }}
            transition={{ duration: 2.8, repeat: Infinity, ease: "easeInOut" }}
          />
          <div className="absolute h-44 w-44 sm:h-52 sm:w-52 rounded-full border border-primary/40" />
          ...
          <div className="absolute text-center">
            <motion.p className="text-3xl sm:text-4xl font-semibold">{animatedText}</motion.p>
